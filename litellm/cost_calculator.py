...
def _infer_call_type(
    ...
    response_type = type(completion_response)

    if response_type is ModelResponse:
        return "completion"
    elif response_type is EmbeddingResponse:
        return "embedding"
    elif response_type is TranscriptionResponse:
        return "transcription"
    elif response_type is HttpxBinaryResponseContent:
        return "speech"
    elif response_type is RerankResponse:
        return "rerank"
    elif response_type is ImageResponse:
        return "image_generation"
    elif response_type is TextCompletionResponse:
