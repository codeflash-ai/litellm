...
def handle_realtime_stream_cost_calculation(
    ...
    # Use the first found, or fallback
    potential_model_names = []
    ...
    for model_name in potential_model_names:
        try:
            ...
            continue
        total_cost = _input_cost_per_token + _output_cost_per_token
        return total_cost  # exit and return immediately after first valid calculation

    return 0.0  # fallback in case no calculation is possible
