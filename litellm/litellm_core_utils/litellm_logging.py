...
def create_dummy_standard_logging_payload() -> StandardLoggingPayload:
    ...
    # Precompute token counts to avoid double lookup
    prompt_token_count = DEFAULT_MOCK_RESPONSE_PROMPT_TOKEN_COUNT
    completion_token_count = DEFAULT_MOCK_RESPONSE_COMPLETION_TOKEN_COUNT
