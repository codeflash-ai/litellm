...
def cost_per_token(model: str, usage: Usage) -> Tuple[float, float]:
    ...
    prompt_cost: float = prompt_tokens * input_cost_per_token
    ...
    completion_cost: float = completion_tokens * output_cost_per_token
    ...
    if prompt_tokens_details:
        num_search_queries = getattr(prompt_tokens_details, "web_search_requests", 0) or 0
