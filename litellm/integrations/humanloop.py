...
class HumanLoopPromptManager(DualCache):
    ...
    def _get_model_from_prompt(self, prompt_management_client: PromptManagementClient, model: str) -> str:
        # Fast path: read local reference once, avoiding repeated dict lookups
        client_model = prompt_management_client["model"]
        if client_model is not None:
            return client_model
        # Use f-string instead of .format for string interpolation
