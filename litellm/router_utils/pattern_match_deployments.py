...
class PatternMatchRouter:
    ...
    def _return_pattern_matched_deployments(self, matched_pattern: Match, deployments: List[Dict]) -> List[Dict]:
        ...
        for deployment in deployments:
            ...
            new_deployment["litellm_params"] = deployment["litellm_params"].copy()
    ...
    def set_deployment_model_name(
        ...
        # Performance: str.replace in a loop is fastest; using an iterator for dynamic_segments is marginally more efficient
        # but keep code as-is for readability and correctness as it's not in a tight loop
